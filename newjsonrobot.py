from newprelaunch import jornada as howmany
from newjsonbuilder import match, score1, score2, lstjornada
import json
import pprint
from newdaterobot import lstnuevafecha
...
# print score1, score2
fhand = open('bundesligaXX.json', 'w')
